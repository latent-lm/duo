...
python unigram/unigram_test2_tmp2.py -m \
  ...
  hydra.sweep.subdir=lorentz_cartesian_opt_tmp_rlog_newd2_ts4000000_cmplx_ps1 \
  +mode=opt \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
...
python unigram/unigram_test2_tmp2.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=poincare_polar_opt_tmp_rlog_newd2_ts4000000_cmplx_ps1 \
  +mode=opt \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
...
python unigram/unigram_test2_tmp2.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=lorentz_cartesian_tnb_tmp_rlog_newd2_ts4000000_cmplx_ps1 \
  +mode=tnb \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
...
python unigram/unigram_test2_tmp2.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=poincare_polar_tnb_tmp_rlog_newd2_ts4000000_cmplx_ps1 \
  +mode=tnb \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
