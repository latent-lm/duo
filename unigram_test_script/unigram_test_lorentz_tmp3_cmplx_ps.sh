...
python unigram/unigram_test2_tmp3.py -m \
  ...
  hydra.sweep.subdir=lorentz_cartesian_opt_tmp3_rlog_newd2_rot_ts4000000_cmplx_ps \
  +mode=opt \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
  '+ps=[0.31,0.01,0.2,0.01,0.01,0.3,0.08,0.04,0.03,0.01]' \
  +proposal_type=unif \
...
python unigram/unigram_test2_tmp3.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=poincare_polar_opt_tmp3_rlog_newd2_rot_ts4000000_cmplx_ps \
  +mode=opt \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
...
python unigram/unigram_test2_tmp3.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=lorentz_cartesian_tnb_tmp3_rlog_newd2_rot_ts4000000_cmplx_ps \
  +mode=tnb \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
...
python unigram/unigram_test2_tmp3.py -m \
  hydra.job.chdir=true \
  hydra.sweep.dir=outputs/unigram_test2 \
  hydra.sweep.subdir=poincare_polar_tnb_tmp3_rlog_newd2_rot_ts4000000_cmplx_ps \
  +mode=tnb \
  +vocab_size=10 \
  +max_steps=20000 \
  +lr=1e-5 \
