...
#   hydra.sweep.subdir=lorentz_cartesian_opt_tmp2 \
#   +mode=opt \
#   +vocab_size=2 \
#   +max_steps=20000 \
#   +lr=1e-5 \
...
# Exp
  ...
  #   hydra.job.chdir=true \
  #   hydra.sweep.dir=outputs/unigram_test2 \
  #   hydra.sweep.subdir=lorentz_cartesian_opt_tmp_rlog_newd_rot_ts4000000 \
  #   +mode=opt \
  #   +vocab_size=2 \
  #   +max_steps=20000 \
  #   +lr=1e-5 \
  ...
  #   hydra.job.chdir=true \
  #   hydra.sweep.dir=outputs/unigram_test2 \
  #   hydra.sweep.subdir=lorentz_cartesian_opt_tmp_rlog_newd2_rot_ts4000000 \
  #   +mode=opt \
  #   +vocab_size=10 \
  #   +max_steps=20000 \
  #   +lr=1e-5 \
...
#   hydra.job.chdir=true \
#   hydra.sweep.dir=outputs/unigram_test2 \
#   hydra.sweep.subdir=poincare_polar_opt_tmp2 \
#   +mode=opt \
#   +vocab_size=2 \
#   +max_steps=20000 \
#   +lr=1e-5 \
...
# Exp
  ...
  #   hydra.job.chdir=true \
  #   hydra.sweep.dir=outputs/unigram_test2 \
  #   hydra.sweep.subdir=poincare_polar_opt_tmp_rlog_newd2_rot_ts4000000 \
  #   +mode=opt \
  #   +vocab_size=2 \
  #   +max_steps=20000 \
  #   +lr=1e-5 \
...
#   hydra.job.chdir=true \
#   hydra.sweep.dir=outputs/unigram_test2 \
#   hydra.sweep.subdir=lorentz_cartesian_tnb_tmp \
#   +mode=tnb \
#   +vocab_size=2 \
#   +max_steps=20000 \
#   +lr=1e-5 \
...
#   hydra.job.chdir=true \
#   hydra.sweep.dir=outputs/unigram_test2 \
#   hydra.sweep.subdir=poincare_polar_tnb_tmp \
#   +mode=tnb \
#   +vocab_size=2 \
#   +max_steps=20000 \
#   +lr=1e-5 \
